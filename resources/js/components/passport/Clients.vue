...
<script>
    export default {
        ...
        methods: {
             ...
             */
            getClients() {
                axios.get('/auth/public/oauth/clients')
                        .then(response => {
            ...
            update() {
                this.persistClient(
                    'put',
                    '/auth/public/oauth/clients/' + this.editForm.id,
                    this.editForm,
                    '#modal-edit-client'
                );
            },
             ...
             */
            destroy(client) {
                axios.delete('/auth/public/oauth/clients/' + client.id)
                        .then(response => {
                            this.getClients();
                        });
            }
